...
namespace TestWebNotCore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            get => m_signInManager ?? HttpContext.GetOwinContext().Get<ApplicationSignInManager>();
            private set => m_signInManager = value;
        }

        public ApplicationUserManager UserManager
        {
            get => m_userManager ?? HttpContext.GetOwinContext().GetUserManager<ApplicationUserManager>();
        ...
        private const string c_XSRF_KEY = "XsrfId";
        ...
        internal class ChallengeResult : HttpUnauthorizedResult
        {
            ...
            public override void ExecuteResult(ControllerContext context)
            {
                ...
                if (UserId != null)
                {
                    properties.Dictionary[c_XSRF_KEY] = UserId;
                }
